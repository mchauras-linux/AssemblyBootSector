...
; However, BIOS places our bootsector binary at address 0x7c00 and the offset is added by org command
; so we don't need padding.
mov al, "2"
int 0x10
mov al, [the_secret]
int 0x10
...
; attempt 3
; Add the BIOS starting offset 0x7c00
; and then dereference the contents of that pointer.
; The Address will be wrong as the offset is already added by the org command
...
; attempt 4
; In this the offset will not be added by th e org command as the address is dereferenced as absolute address
